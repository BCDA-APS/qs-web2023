...
function ViewResults({ obj }) {
    //Component to display the plan results

    //Used to toggle between whether the modal is open or closed
    const [modal, setModal] = useState(false);

    //Used to control when the icon changes color
    const [ isHover, setHover] = useState(false);

    //Used to set whether the modal is open or not
